...
C_SRCS += \
../Core/Src/common/formatter_data.c 

OBJS += \
./Core/Src/common/formatter_data.o 

C_DEPS += \
./Core/Src/common/formatter_data.d 
...
clean-Core-2f-Src-2f-common:
	-$(RM) ./Core/Src/common/formatter_data.cyclo ./Core/Src/common/formatter_data.d ./Core/Src/common/formatter_data.o ./Core/Src/common/formatter_data.su
